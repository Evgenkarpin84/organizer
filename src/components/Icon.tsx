...
const PATHS: Record<IconName, string[]> = {
  ...
  settings: [
    ...
    'M19.4 13.5a7.7 7.7 0 0 0 0-3l1.7-1.3-2-3.4-2 .8a7.6 7.6 0 0 0-2.6-1.5L14 3h-4l-.5 2.1a7.6 7.6 0 0 0-2.6 1.5l-2-.8-2 3.4 1.7 1.3a7.7 7.7 0 0 0 0 3L2.9 15l2 3.4 2-.8a7.6 7.6 0 0 0 2.6 1.5L10 21h4l.5-2.1a7.6 7.6 0 0 0 2.6-1.5l2 .8 2-3.4z',
  ],
}
